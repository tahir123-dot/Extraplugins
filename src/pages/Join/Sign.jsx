...
const Sign = () => {
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      {/* Left Side - Stylish Purple Section */}
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-purple-700 to-indigo-800 items-center justify-center px-10 py-12 relative">
        ...
        <div className="text-white text-center z-10 space-y-6 max-w-md">
          ...
          <p className="text-lg font-light leading-relaxed">
            ...
            and unlock exclusive access to industry-level{" "}
            <strong>Kontakt Libraries</strong>, premium{" "}
            <strong>Audio Plugins</strong>, and high-quality{" "}
            <strong>Sound Packs</strong>.
          </p>
